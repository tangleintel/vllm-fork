...
class SchedulerConfig:
    ...
    def __init__(self,
                 ...
                 policy: str = "fcfs",
                 padding_aware_scheduling: bool = False) -> None:
        ...
        self.policy = policy
        self.padding_aware_scheduling = padding_aware_scheduling
        self._verify_args()
    ...
    def _verify_args(self) -> None:
        ...
        if self.num_scheduler_steps < 1:
            raise ValueError(
                ...
                "equal to 1.")
        if self.padding_aware_scheduling and self.chunked_prefill_enabled:
            raise ValueError("Padding-aware scheduling does"
